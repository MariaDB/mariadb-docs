---
description: >-
  Complete FLUSH statement reference: NO_WRITE_TO_BINLOG/LOCAL syntax, FLUSH
  TABLES WITH READ LOCK/FOR EXPORT, FLUSH STATUS, and SSL/TLS certificate
  reload.
---
...
By default, `FLUSH` statements are written to the [binary log](../../../../server-management/server-monitoring-logs/binary-log/) and will be [replicated](../../../../ha-and-performance/standard-replication/). The `NO_WRITE_TO_BINLOG` keyword (`LOCAL` is an alias) ensures that the statement is not written to the binary log. The different flush options are:
...
| DES\_KEY\_FILE                                      | Reloads the DES key file (specified with the [--des-key-file startup option](../../../../server-management/starting-and-stopping-mariadb/mariadbd-options.md)). **Removed in MariaDB 13.0**, together with the `DES_ENCRYPT()`/`DES_DECRYPT()` functions.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| QUERY\_RESPONSE\_TIME\_READ                         | See the [QUERY\_RESPONSE\_TIME](../../../plugins/other-plugins/query-response-time-plugin.md) plugin. From [MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| QUERY\_RESPONSE\_TIME\_READ\_WRITE                  | See the [QUERY\_RESPONSE\_TIME](../../../plugins/other-plugins/query-response-time-plugin.md) plugin. From [MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| QUERY\_RESPONSE\_TIME\_WRITE                        | See the [QUERY\_RESPONSE\_TIME](../../../plugins/other-plugins/query-response-time-plugin.md) plugin. From [MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| SLAVE                                               | Deprecated option, use [RESET SLAVE or RESET REPLICA](../replication-statements/reset-replica.md) instead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| SSL                                                 | Used to dynamically reinitialize the server's [TLS](../../../../security/encryption/data-in-transit-encryption/) context by reloading the files defined by several [TLS system variables](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md). See [FLUSH SSL](flush.md#flush-ssl) for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| \[ GLOBAL \| SESSION ] STATUS                       | Resets all [server status variables](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-status-variables.md) that can be reset to 0. Not all global status variables support this, so not all global values are reset. From MariaDB 11.5, `GLOBAL` or `SESSION` can be specified. See [FLUSH STATUS](flush.md#flush-status) for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| TABLE\[S] ... FOR EXPORT                            | For InnoDB tables, flushes table changes to disk to permit binary table copies while the server is running. See [FLUSH TABLES ... FOR EXPORT](flush-tables-for-export.md) for more.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| USER\_RESOURCES                                     | Resets all per hour [user resources](../../account-management-sql-statements/grant.md#resource-limit-options). This enables clients that have exhausted their resources to connect again.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
You can also use the [mariadb-admin](../../../../clients-and-utilities/administrative-tools/mariadb-admin.md) client to flush things. Use `mariadb-admin --help` to examine what flush statements it supports.
...
### FLUSH TABLES _table\_list_

`FLUSH TABLES`` `_`table_list`_ is useful if you want to copy a table object or files to or from the server. This statement puts a lock that stops new users of the table and will wait until everyone has stopped using the table. The table is then removed from the table definition and table cache.
...
### Implementation of FLUSH TABLES _table\_list_
...
### Implementation of FLUSH TABLES _table\_list_ FOR EXPORT
...
The `FLUSH SSL` command can be used to dynamically reinitialize the server's [TLS](../../../../security/encryption/data-in-transit-encryption/) context. This is most useful if you need to replace a certificate that is about to expire without restarting the server.

This operation is performed by reloading the files defined by the following [TLS system variables](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md):

* [ssl\_cert](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_cert)
* [ssl\_key](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_key)
* [ssl\_ca](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_ca)
* [ssl\_capath](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_capath)
* [ssl\_crl](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_crl)
* [ssl\_crlpath](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_crlpath)

These [TLS system variables](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md) are not dynamic, so their values can **not** be changed without restarting the server.

If you want to dynamically reinitialize the server's [TLS](../../../../security/encryption/data-in-transit-encryption/) context, then you need to change the certificate and key files at the relevant paths defined by these [TLS system variables](../../../../security/encryption/data-in-transit-encryption/ssltls-system-variables.md), without actually changing the values of the variables. See [MDEV-19341](https://jira.mariadb.org/browse/MDEV-19341) for more information.
